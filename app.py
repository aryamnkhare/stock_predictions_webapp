...
if selected == "Know More":
    ...
    st.markdown("""There is no correct way to predict the stock prices with 100 percent accuracy. 
        ...
        In most cases, the human intelligence factor is one of the most important decision making parameters in predicting the stock prices""")